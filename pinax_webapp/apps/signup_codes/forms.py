...
class SignupForm(BaseSignupForm):
    signup_code = forms.CharField(max_length=40, required=False, widget=forms.TextInput())
    signup_badge = forms.CharField(max_length=40, required=False, widget=forms.TextInput())
