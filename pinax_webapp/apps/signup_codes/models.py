...
class SignupCode(models.Model):
    """
    """
    code = models.CharField(max_length=40) #the code
    badge = models.CharField(max_length=40) #the badge
...
def check_signup_code(code,badge):
    if code and badge:
        try:
            signup_code = SignupCode.objects.get(code=code,badge=badge)
